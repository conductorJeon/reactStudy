...
function BoardUpdate() {
    ...
    useEffect(() => {
        dispatch(boardUpdateActions(no));
    })

    const update = useSelector(state => state.boards.board_update)
    ...
    const updateOk = () => {
        ...
        dispatch(boardUpdateOkActions(params));
    }
                ...
                <table className={"table"}>
                    ...
                    <tr>
                        <td className={"text-center"} colSpan={2}>
                            <button className={"btn btn-sm btn-primary"} onClick={updateOk}>글쓰기</button>
